...
function renderPreview(data) {
  ...
  const totalAbonos = data.totalAbonos ?? abonos.reduce((sum, a) => sum + (Number(a.monto) || 0), 0); // Usa 'monto'
  const saldoPendiente = data.saldoPendiente ?? (totalGeneral - totalAbonos);
